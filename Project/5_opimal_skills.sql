...
Target skills that offer job securities and financial benefits.

demand_skills table is from query 3 and average_salary is from query 4.
Notice the changes in both codes since we are joining using skill_id and grouping by it.
*/
